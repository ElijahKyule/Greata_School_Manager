...
class SubjectsController extends AppController
{
    ...
    public function view($id = null)
    {
        $subject = $this->Subjects->get($id, [
            'contain' => ['Users', 'ExamSubjects'=>['Subjects', 'Measures', 'Exams'], 'StudentSubjects'=>['Subjects', 'Students',]],
        ]);
    ...
    public function addSubject($id)
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Subjects->save($subject)) {
                ...
                return $this->redirect(['controller'=>'Users','action'=>'view',$id, '?'=>['tab'=>'subjects']]);
            }
            $this->Flash->error(__('The subject could not be saved. Please, try again.'));
        }
        $users = $this->Subjects->Users->find('list', ['limit' => 200])->where(['id'=>$id]);
        $this->set(compact('subject', 'users', 'id'));
    }
    ...
    public function editSubject($id)
    {
        ...
        $selected_users = $this->Subjects->find()
            ->select(['user_id'])
            ->where(['id' => $id])
            ->first();
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            if ($this->Subjects->save($subject)) {
                ...
                return $this->redirect(['controller'=>'Users','action'=>'view',$selected_user, '?'=>['tab'=>'subjects']]);
            }
            $this->Flash->error(__('The subject could not be saved. Please, try again.'));
        }
        $users = $this->Subjects->Users->find('list', ['limit' => 200]);
        $this->set(compact('subject', 'users', 'selected_user'));
    }
