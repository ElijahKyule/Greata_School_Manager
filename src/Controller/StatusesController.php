...
class StatusesController extends AppController
{
    ...
    public function view($id = null)
    {
        $status = $this->Statuses->get($id, [
            'contain' => ['Students'=>['Genders'], 'Fees'=>['Terms','Levels'], 'Exams'=>['Examtypes', 'Terms', 'Levels','Users'], 'Employees'=>['Genders', 'Roles'], 'ClassroomActivities'=>['Classrooms', 'Activities', 'Measures'], 'StudentActivities'=>['Students', 'Activities', 'Measures']],
        ]);
