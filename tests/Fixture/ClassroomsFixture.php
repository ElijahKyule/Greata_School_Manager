...
class ClassroomsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'stream_id' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'level_id' => 1,
                'stream_id' => 'Lorem ipsum dolor sit amet',
                'user_id' => 1,
                'created' => '2021-04-15 07:16:22',
                'modified' => '2021-04-15 07:16:22',
            ],
        ];
        parent::init();
    }
