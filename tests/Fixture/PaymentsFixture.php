...
class PaymentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'balance' => ['type' => 'decimal', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'reference_number' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'created' => '2021-04-06 07:26:57',
                'modified' => '2021-04-06 07:26:57',
            ],
        ];
        parent::init();
    }
