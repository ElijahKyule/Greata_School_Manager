...
class MeasuresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'abbreviation' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-04-27 14:34:30',
                'modified' => '2021-04-27 14:34:30',
            ],
        ];
        parent::init();
    }
