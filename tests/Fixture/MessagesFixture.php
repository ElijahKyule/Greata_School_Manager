...
class MessagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'messagestatus_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'messagestatus_id' => 1,
                'created' => '2021-05-07 15:47:58',
                'modified' => '2021-05-07 15:47:58',
            ],
        ];
        parent::init();
    }
