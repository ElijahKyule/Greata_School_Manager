    ...
    <div class="content-head index">
        ...
        <div class = "pull-right">
           <?= $this->Html->link(__(' List'), ['action' => 'index'], ['class' => 'btn btn-success fa fa-list']) ?>
            ...
            <?= $this->Form->postLink(
                __(' Delete'),
                ['action' => 'delete', $feeStructureParameter->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $feeStructureParameter->id), 'class' => 'btn btn-success float-right fa fa-trash']
            ) ?>
