...
<div>
    <div class="content-head index">
        <div class = "pull-left">
            <h4 class="heading"><?= __('Edit Payment Mode') ?></h4>
        </div>
        <div class = "pull-right">
           <?= $this->Html->link(__(' List'), ['action' => 'index'], ['class' => 'btn btn-success fa fa-list']) ?>
            ...
            <?= $this->Form->postLink(
                __(' Delete'),
                ['action' => 'delete', $paymentmode->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $paymentmode->id), 'class' => 'btn btn-success float-right fa fa-trash']
            ) ?>
