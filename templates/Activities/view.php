...
?>
    <div class="content-head index">
        ...
        <div class="pull-right">
            ...
            <?= $this->Form->postLink(__(' Delete'), ['action' => 'delete', $activity->id], ['confirm' => __('Are you sure you want to delete # {0}?', $activity->id), 'class' => 'btn btn-success float-right fa fa-trash']) ?>
            <?= $this->Html->link(__(' Edit'), ['action' => 'edit', $activity->id], ['class' => 'btn btn-success float-right fa fa-edit']) ?>
