...
<div>
    <div class="content-head index">
        <div class = "pull-left">
            <h4 class="heading"><?= __('New Exam') ?></h4>
        </div>
        <div class = "pull-right">
           <?= $this->Html->link(__(' List'), ['controller'=>'Users','action'=>'view',$id, '?'=>['tab'=>'exams']], ['class' => 'btn btn-success fa fa-list']) ?>
        </div>
        ...
        <div class="exams form content">
            ...
            <fieldset>
                <?php
                    ...
                    echo $this->Form->control('user_id', ['options' => $users, 'label'=>'Assigned To']);
                ?>
            </fieldset>
