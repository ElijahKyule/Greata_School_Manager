...
<div>
    <div class="content-head index">
        <div class = "pull-left">
            <h4 class="heading"><?= __('Edit Student Subject Marks') ?></h4>
        </div>
        <div class = "pull-right">
           <?= $this->Html->link(__(' List'), ['controller'=>'Students', 'action' => 'view', $selected_student, '?'=>['tab'=>'subjectmarks']], ['class' => 'btn btn-success fa fa-list']) ?> 
        </div>
    </div>
</div>
