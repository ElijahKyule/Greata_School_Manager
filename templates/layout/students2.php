...
<head>
    ...
    <?= $this->Html->script(['jquery/dist/jquery.min', 'moment.min', 'js/adminlte.min', 'js1/bootstrap.min', 'datatables/datatables.min', 'fullcalendar.min']) ?>
    <?= $this->Html->css([ 'normalize.min', 'milligram.min', 'cake', 'buttons', 'table', 'default', 'css/bootstrap.min', 'font-awesome/css/font-awesome.min', 'fontawesome/css/all.min', 'Ionicons/css/ionicons.min','AdminLTE', 'skins/skin-green.min', 'fullcalendar.min']) ?>
