...
<div>
    <div class="content-head index">
        <div class = "pull-left">
            <h4 class="heading"><?= __('New Employee Leave') ?></h4>
        </div>
        <div class = "pull-right">
           <?= $this->Html->link(__(' List'), ['controller'=>'Users', 'action' => 'view', $id,'?'=>['tab'=>'leaves']], ['class' => 'btn btn-success fa fa-list']) ?>
        </div>
...
<div>
    <div class="column-responsive column-80">
        <div class="employeeLeaves form content">
            ...
            <fieldset>
                <?php
                    echo $this->Form->control('employee_id', ['options' => $employees, 'empty'=>'Select..',]);
                    ...
                    echo $this->Form->control('user_id', ['options' => $users, 'label'=>'Authorized by']);
                ?>
            </fieldset>
