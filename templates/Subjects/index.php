        ...
        <table class='table table-striped table-condensed' width="100%">
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('user_id', ['label'=>'Subject Teacher']) ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink('', ['action' => 'delete', $subject->id], ['confirm' => __('Are you sure you want to delete # {0}?', $subject->name), 'class'=>'fa fa-trash-alt btn btn-xs btn-default']) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
